========================================================================
    KONSOLENANWENDUNG: 3_grafik-Projektübersicht
========================================================================

Diese 3_grafik-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 3_grafik-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 3_grafik.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
